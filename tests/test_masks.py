...
def test_get_mask_card_number_valid(valid_card_numbers, expected_mask_numbers):
...
def test_get_mask_account_valid(valid_account_numbers, expected_mask_accounts):
