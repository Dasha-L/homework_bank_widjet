...
def test_filter_by_state_correct(transactions, state, expected_filtered_transactions):
...
def test_sort_by_date_correct(transactions, reverse, sorted_transactions):
    """Тестирование сортировки списка словарей по датам в порядке убывания и возрастания."""
    assert sort_by_date(transactions, reverse) == sorted_transactions


def test_sort_by_date_with_same_dates(transactions_with_same_dates):
...
def test_sort_by_date_with_invalid_dates(transactions_with_invalid_dates):
